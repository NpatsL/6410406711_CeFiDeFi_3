...
//flash loan USDC ออกมา ต้องคืนด้วย WETH
        console.log("debt_USDC: %s", debt_USDC);
        console.log("USDC before flash loan: %s", USDC.balanceOf(address(this)));
    ...
    function uniswapV2Call(
        ...
        console.log("USDC after flash loan: %s", USDC.balanceOf(address(this)));
...
// จ่ายหนี้ USDC แทนแล้วได้ collateral WETH ออกมา 
        ...
        console.log("collateral WETH: %s", collateral_WETH);
    

// จ่ายหนี้ flash loan ด้วย WETH
        ...
        console.log("repay WETH: %s", repay_WETH);
        console.log("--------------------------");
